...
REG ADD "HKCU\SOFTWARE\Classes\Local Settings\SOFTWARE\Microsoft\Windows\Shell\Bags\AllFolders\Shell\{7d49d726-3c21-4f05-99aa-fdc2c9474656}" /V Vid /T REG_SZ /D {0057D0E0-3573-11CF-AE69-08002B2E1262} /F:: Disable Auto Arrange for Music folder template
